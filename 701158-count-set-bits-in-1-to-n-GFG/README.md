# [Count Set Bits in 1 to n](https://www.geeksforgeeks.org/problems/count-total-set-bits-1587115620/1)
## Medium
Given a number n. Return the total count of set bits for all numbers from 1 to n (both inclusive).Examples :
Input: n = 4
Output: 5
